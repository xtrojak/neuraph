...
Pre neúspech so šachovými ťahmi sme sa rozhodli riešiť ešte jeden problém. Ideou je, že sa sieti predhodí polynóm a ona vráti jeho deriváciu. 

{\centering\textbf{Príklad}\\}
...
\noindent takže konečným vstupom pre sieť je sekvencia čísel "\textbf{0 0 5 0 2 8}".
